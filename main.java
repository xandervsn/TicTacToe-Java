...
public class TicTacToe {
   ...
   xWins++;
   System.out.println("X wins! Do you want to play again? Type Y for yes and N for no.\n"+"X's Wins: "+xWins+"\nO's Wins: "+oWins+"\nTies: "+ties);
      } else if(checkWin(O_MOVE) == true){
         oWins++;
         System.out.println("O wins! Do you want to play again? Type Y for yes and N for no.\n"+"X's Wins: "+xWins+"\nO's Wins: "+oWins+"\nTies: "+ties);
      } else {
         ties++;
            System.out.println("Tie! Do you want to play again? Type Y for yes and N for no.\n"+"X's Wins: "+xWins+"\n O'sWins: "+oWins+"\nTies: "+ties);
      }
...
public boolean checkTie() { // checks if there is a tie (if the board is full, and there is no winner)
